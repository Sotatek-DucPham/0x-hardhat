...
contract MixinAssetProxyDispatcher is Ownable, IAssetProxyDispatcher {
    ...
    function registerAssetProxy(address assetProxy) external onlyOwner {
        ...
        require(currentAssetProxy == address(0), "ASSET_PROXY_ALREADY_EXISTS");
    ...
    function _dispatchTransferFrom(
        ...
        if (amount > 0 && from != to) {
            ...
            require(assetData.length > 3, "LENGTH_GREATER_THAN_3_REQUIRED");
            ...
            require(assetProxy != address(0), "ASSET_PROXY_DOES_NOT_EXIST");
